...
class PushSimpleLog
{
     ...
     * @param string $prefix
     */
    public function dev($log, $prefix = null)
    {
     ...
     * @param string $prefix
     */
    public function fault($log, $prefix = null)
    {
     ...
     * @param string $prefix
     */
    public function debug($log, $prefix = null)
    {
        $this->dev($log, $prefix);
    }
    /**
     ...
     * @param string $prefix
     */
    public function log($log, $prefix = null)
    {
     ...
     * @param string $prefix
     */
    public function err($log, $prefix = null)
    {
        $this->fault($log, $prefix);
    }
     ...
     * @return void
     */
    public function __construct($out = 'disable', $level = 1)
    {
