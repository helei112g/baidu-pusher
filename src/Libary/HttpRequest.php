...
class HttpRequest
{
     ...
     * @throws Exception
     */
    public function __construct($urlBase = null, $opts = array(), $log = null)
    {
     ...
     * @return boolean
     */
    public function isMatchReg($match, $str)
    {
     ...
     *         )
     */
    public function request($path = '', $method = "GET", $payload = "", $reqHeaders = null, $curlOpts = null)
    {
        if ($path === null) {
     ...
     *         )
     */
    public function get($path, $query = null, $headers = null, $curlOpts = null)
    {
     ...
     *         )
     */
    public function post($path = null, $postBody = null, $headers = null, $curlOpts = null)
    {
