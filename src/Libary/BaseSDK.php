...
class BaseSDK
{
     ...
     * @return string
     */
    public function genSign($method, $url, $arrContent)
    {
    ...
    public function newApiQueryTpl()
    {
        ...
        if ($this->deviceType === null && config('pusher.default_devicetype') !== null) {
            $this->setDeviceType(config('pusher.default_devicetype'));
        }
